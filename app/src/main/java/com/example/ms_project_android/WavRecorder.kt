/*
    JLibRosa only supports wav audio files so we must record wav files.
    Unfortunately android MediaRecorder does not support recording wav files:
        https://developer.android.com/reference/android/media/MediaRecorder.AudioEncoder
        https://developer.android.com/reference/android/media/MediaRecorder.OutputFormat
    File taken from: https://stackoverflow.com/questions/5245497/how-to-record-wav-format-file-in-android
*/
